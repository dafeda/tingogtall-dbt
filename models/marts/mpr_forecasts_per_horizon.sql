...
WITH published AS (
    SELECT 'MPR 3/16' AS raport, '2016M09' AS year_month_published
    UNION ALL
    SELECT 'MPR 4/16' AS raport, '2016M12' AS year_month_published
    UNION ALL
    SELECT 'MPR 1/17' AS raport, '2017M03' AS year_month_published
    UNION ALL
    SELECT 'MPR 2/17' AS raport, '2017M06' AS year_month_published
    UNION ALL
    SELECT 'MPR 3/17' AS raport, '2017M09' AS year_month_published
    UNION ALL
    SELECT 'MPR 4/17' AS raport, '2017M12' AS year_month_published
    UNION ALL
    SELECT 'MPR 1/18' AS raport, '2018M03' AS year_month_published
    UNION ALL
